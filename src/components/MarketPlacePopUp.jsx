...
import { Button, Col, DatePicker, Drawer, Form, Input, Row, Space, Upload, message } from 'antd';
...
const MarketPlacePopUp = () => {
  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'end', width: '100%' }}>
      <Button type="primary" onClick={showDrawer} icon={<PlusOutlined />} className="MarketPlacePopUp-btn">
        Add Item
      </Button>
      <Drawer
        title="Add a Product "
      ...
      >
        <Form form={form} layout="vertical" hideRequiredMark>
          ...
          rules={[
            {
              required: true,
              message: 'If you want to Donate enter 0 ',
            },
           
          ]}
          >
          <Input placeholder="Enter 0 for donation" />
          </Form.Item>
